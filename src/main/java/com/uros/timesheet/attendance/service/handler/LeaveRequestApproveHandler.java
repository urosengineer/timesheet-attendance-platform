...
public class LeaveRequestApproveHandler {
    ...
    public LeaveRequestResponse handle(UUID id, UUID approverId) {
        ...
        if (entity.getUser().getId().equals(approverId)) {
            throw new IllegalArgumentException(messageUtil.get("error.leaverequest.approve.self"));
        }
